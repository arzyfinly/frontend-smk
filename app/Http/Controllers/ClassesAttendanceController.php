...
class ClassesAttendanceController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        ])->get('http://localhost/PA/backend-smk/public/api'.'/classes-attendances')->json();
        $classesattendances = json_decode(json_encode($data))->classesattendances;
        // dd($classesattendances);
        if($request->ajax()){
            return DataTables::of($classesattendances)
            ...
            return view('admin.classes-attendances.index', compact('classesattendances'));
    }
